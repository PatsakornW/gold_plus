                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered ">
                                    ...
                                    <tbody>
                                        @php($counter = ($dataApproved->currentPage() - 1) * $dataApproved->perPage())
                                        @foreach ($dataApproved as $value)
                                        <tr>
                                            <td>{{ ++$counter }}</td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="border-0 border bg-white" data-bs-toggle="modal" data-bs-target="#detail_approve" onclick="showModal('{{ json_encode($value) }}')"><i class="fa-solid fa-eye"></i></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<!-- modal   -->
<div class="modal fade" id="detail_approve" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
