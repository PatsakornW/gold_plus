                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered ">
                                    ...
                                    <tbody>
                                        @php($counter = ($dataNotApproved->currentPage() - 1) * $dataNotApproved->perPage())
                                        @foreach ($dataNotApproved as $value)
                                        <tr>
                                            <td>{{ ++$counter }}</td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="border-0 border bg-white" data-bs-toggle="modal" data-bs-target="#detail_notapprove" onclick="showModal('{{ json_encode($value) }}')"><i class="fa-solid fa-eye"></i></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
<!-- modal   -->
<div class="modal fade" id="detail_notapprove" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="container ">
                    <div class="row">
                        ...
                        <div class="col-12  mt-3">
                            <div class="row mt-3">
                                <p class="text-center">สถานะ : <span class="fw-bold text-danger" id="status"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
